...
def main() -> None:
    ...
    parser.add_argument("--sims", type=int, default=800, help="Simulations per core.")
    parser.add_argument("--iterations", type=int, default=1, help="Repeated runs to accumulate stats.")
    parser.add_argument("--batch-leaves", type=int, default=512, help="Leaf batch size per MCTS core.")
    ...
    parser.add_argument("--inference-warmup-iters", type=int, default=50, help="Warmup iterations for graph capture.")
    parser.add_argument("--timeout-ms", type=int, default=20, help="EvalBatcher flush timeout in ms.")
