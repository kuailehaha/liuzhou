...
- The initial seeded 500-game gate scored `433-0-67` (`86.60%`, black `217-0-33`, white `216-0-34`) in `114.64s` with zero device fallback. Iteration 50 reached `495-0-5/500` and passed the independent confirmation at `497-0-3/500`; its sampled 500-game incumbent gate was `203-106-191`, so the candidate was promoted.
- The initial `--stop-on-target` exit was clean. At user request the run resumed at `2026-07-22T10:34:05Z` from the same iteration-50 model/optimizer pair, rolling replay and original deadline, but without further target-triggered stopping. Iteration 51 committed with optimizer continuity, replay 47–50, zero fallback and zero filtered non-finite samples. The end-of-deadline retained model and stronger-opponent/tournament strength remain unverified.
